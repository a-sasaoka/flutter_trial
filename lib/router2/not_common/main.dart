...
import 'package:flutter_trial/router2/not_common/router.dart';
  ...
  runApp(
    ProviderScope(
      overrides: [
        ...
        page1RouteCallbackProvider.overrideWithValue(page1Route),
        page3RouteCallbackProvider.overrideWithValue(page3Route),
      ],
      child: const MyApp(),
    ),
  );
...
/// Page1への遷移を実装するコールバック関数
void page1Route(BuildContext context) {
  Page1Route().go(context);
}

/// Page3への遷移を実装するコールバック関数
void page3Route(BuildContext context, int index) {
